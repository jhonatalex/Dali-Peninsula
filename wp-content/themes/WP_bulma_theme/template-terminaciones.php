    ...
    <div class="hero-body brillo2">
        <div class="container"> 
            <div class="columns is-centered has-text-white" >
                <div class="column is-5  is-offset-5  has-text-right pt-full-20-terminaciones">
                    ...
                    que se crea a base de las ultimas tendencias... <br class="is-hidden-mobile"> 
        ...
        <div class="container">
            ...
            <div class="columns is-centered is-multiline">
                <div class="column is-four-fifths">           
                    ...
                    <div class="columns f_bozon_r interlineado-2">                        
                        <div class="column  ">
